...
import { DialogBody, DialogFooter, DialogHeader, MobileDialog } from "./index";
        ...
        >
          ...
          <DialogBody className="pb-8 pt-4 text-accent-primary">
            <Text className="mb-6" variant="body1">
              ...
              Ruins, and other inscriptions (“Inscriptions”) within the Unspent
              ...
              or withdrawal fees, which will cause you to lose those
              Inscriptions permanently. This interface will not detect all
              Inscriptions.
            </Text>
